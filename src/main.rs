...
pub const STAR_SPAWN_DURATION: f32 = 1.0;
...
pub fn enemy_hit_player(
    mut commands: Commands,
    mut game_ver_event_writer: EventWriter<GameOver>,
    ...
    if let Ok((player_entity, player_transform)) = player_query.get_single_mut() {
        for enemy_transform in enemy_query.iter() {
            ...
            if distance < player_radius + enemy_radius {
                ...
                game_ver_event_writer.send(GameOver { score: score.value });
            }
        }
    }
}
...
pub fn handle_game_over(mut game_ver_event_reader: EventReader<GameOver>) {
